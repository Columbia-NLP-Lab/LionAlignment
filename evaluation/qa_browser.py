...
if __name__ == "__main__":
    ...
    parser.add_argument("--config-file", type=str, default="src/configs/judge_config.yaml")
    ...
    pairwise_model_judgment_dir = (
        os.path.join("data", configs["bench_name"], "model_judgment", configs["judge_model"], "vs_gpt-4-0314")
    )
