...
from src.trainers.configs import (
    DataArguments, FocusedDPOConfig, LoggingArguments, ModelArguments,
    H4ArgumentParser
)
...
from src.trainers.dpo_selective import tokenize_row
from src.trainers.dpo_focused import DPOFocusedTrainer
...
def main():
    parser = H4ArgumentParser((ModelArguments, DataArguments, LoggingArguments, FocusedDPOConfig))
