...
from src.constants import SFT_DATA_COLUMNS_TO_REMOVE
...
def main():
    ...
    column_names = SFT_DATA_COLUMNS_TO_REMOVE
    ...
    #####################
    # For SFT-2, we ONLY use the "top-ranked" data
    # then we Apply chat template
    #####################
